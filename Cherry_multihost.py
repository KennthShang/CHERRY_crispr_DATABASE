...
parser.add_argument('--infile', type=str, default = 'virus')
parser.add_argument('--outfolder', type=str, default = 'virus')
parser.add_argument('--datasetpth', type=str, default = 'virus')
parser.add_argument('--datasetpth', type=str, default = 'virus')
